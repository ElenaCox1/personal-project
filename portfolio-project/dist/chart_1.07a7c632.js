...
var colorScale = d3.scaleOrdinal().range(['#0015BC', '#99a1e4', '#808080', '#D3D3D3', '#E91D0E', '#f48e86']);
var xPositionScale = d3.scalePoint().range([0, width]);
d3.csv(require('/data/CookCounts.csv')).then(ready).catch(function (err) {
...
},{"d3":"../../../node_modules/d3/index.js","/data/CookCounts.csv":"data/CookCounts.csv"}]},{},["scripts/portfolio_2/chart_1.js"], null)
//# sourceMappingURL=/chart_1.07a7c632.js.map